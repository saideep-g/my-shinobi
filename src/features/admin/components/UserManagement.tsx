...
/**
 * USER MANAGEMENT
 * Admin interface for managing student rosters, assigning curriculum, and setting preferences.
 */
                ...
                <div className="space-y-12 animate-in fade-in duration-500">
                    <div className="bg-app-surface border border-app-border rounded-[40px] overflow-hidden shadow-sm">
                        ...
                        <div className="p-10 space-y-12">
                            ...
                            {/* 5. Chapter Assignment Grid */}
                            <section className="space-y-8">
                                <h4 className="text-xl font-black flex items-center gap-3 px-2">
                                    <BookOpen className="text-indigo-500" /> Master Curriculum Sync
                                </h4>
